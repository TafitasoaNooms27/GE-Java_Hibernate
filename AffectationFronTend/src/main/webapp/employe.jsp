 ...
 <div class="lds-ripple">
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex" >
                            <form role="search" class="app-search d-none d-md-block me-3" style="margin-left:250px;">
                                <input type="text" placeholder="Rechercher par code ou par nom .. "  id="search" class="form-control mt-0" style="width: 400px;">
            ...
            <a href="/AffectationEmploye/employe-add"  class="btn btn-primary" style="margin-left: 90px;margin-top:20px;" role="button"><i class="fa fa-plus"></i></a>

            <div class="container-fluid" >
                <div class="row" >
                    <div class="col-sm-12">
                        <div class="white-box" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 5px;">
                            <h4 class="box-title">Listes des Employe</h4>
                           <br>
                            <div class="table-responsive" >
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0"> Code Employe</th>
                                    ...
                                    <tbody id="empfiltre">
                                        <c:forEach var ="employe" items="${listesAllEmploye}" >
            							<tr>
                								 <td>${employe.codeEmploye} </td>  <td>${employe.nom} </td> <td>${employe.prenom} </td> <td>${employe.poste} </td>
                								 <td><a href="/AffectationEmploye/emp-edit?id=${employe.idEmploye}" class="btn btn-success" role="button"><i class="fas fa-edit"></i></a>
													 <button class="btn btn-danger" onclick="supprimer(${employe.idEmploye})"  data-toggle="modal" data-target="#myModal"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
            										</tr>
           										</c:forEach>
                                    </tbody>
                                </table>
...
`;
	   ...
	   supp.setAttribute("href", "/AffectationEmploye/emp-delete?id="+id);
}
</script>
